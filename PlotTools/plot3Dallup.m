function [ output_args ] = plot3Dallup( allneuron1,allneuron2, allneuron3, allneuron4, baseline_period, test_period, Bbin, Tbin )
% Plot the time course of all the neurons from four types of treatments:
% MPH, PP2, SOV, SALINE
% All the neurons from one treatment are SUBDIVIDED TO 3 GROUPS:
...
%% plot1
figure;
data1 = ratematrix1(result1(result1(:,2) == 1, 1),1:Bbins + Tbins);
sem1 = std(data1)/sqrt(size(data1,1));
x = 1:Bbins + Tbins;
y1 = mean(data1);
error1 = errorbar(x, y1, sem1);
line1 = line(x, y1,'Color', [.3 .8 .2]);
set(error1                            , ...
  'Marker'          , 's'         , ...
  'MarkerSize'      , 8           , ...
  'MarkerEdgeColor' , 'b'         , ...
...
hold on;
%% plot2
data2 = ratematrix2(result2(result2(:,2) == 1, 1),1:Bbins + Tbins);
sem2 = std(data2)/sqrt(size(data2,1));
x = 1:Bbins + Tbins;
y2 = mean(data2);
error2 = errorbar(x, y2, sem2);
line2 = line(x, y2,'Color', [.3 .2 .7]);
set(error2                            , ...
  'Marker'          , '^'         , ...
  'MarkerSize'      , 8           , ...
  'MarkerEdgeColor' , 'b'         , ...
...
set(hE_c(2), 'XData', errorbarXData);
%% plot3
data3 = ratematrix3(result3(result3(:,2) == 1, 1),1:Bbins + Tbins);
sem3 = std(data3)/sqrt(size(data3,1));
x = 1:Bbins + Tbins;
y3 = mean(data3);
error3 = errorbar(x, y3, sem3);
line3 = line(x, y3,'Color', [.7 .2 .2]);
set(error3                            , ...
  'Marker'          , 'o'         , ...
  'MarkerSize'      , 8           , ...
  'MarkerEdgeColor' , 'b'         , ...
...
%% plot4
data4 = ratematrix4(result4(result4(:,2) == 1, 1),1:Bbins + Tbins);
sem4 = std(data4)/sqrt(size(data4,1));
x = 1:Bbins + Tbins;
y4 = mean(data4);
error4 = errorbar(x, y4, sem4);
line4 = line(x, y4,'Color',[.6 .6 .6]);
set(error4                            , ...
  'Marker'          , 'd'         , ...
  'MarkerSize'      , 8           , ...
  'MarkerEdgeColor' , 'b'         , ...
...
%% =========================================  %% ===================================== %%
figure;
data1 = ratematrix1(result1(result1(:,2) == 0, 1),1:Bbins + Tbins);
sem1 = std(data1)/sqrt(size(data1,1));
x = 1:Bbins + Tbins;
y1 = mean(data1);
error1 = errorbar(x, y1, sem1);
...
hold on;
%% plot2
data2 = ratematrix2(result2(result2(:,2) == 0, 1),1:Bbins + Tbins);
sem2 = std(data2)/sqrt(size(data2,1));
x = 1:Bbins + Tbins;
y2 = mean(data2);
error2 = errorbar(x, y2, sem2);
...
set(hE_c(2), 'XData', errorbarXData);
%% plot3
data3 = ratematrix3(result3(result3(:,2) == 0, 1),1:Bbins + Tbins);
sem3 = std(data3)/sqrt(size(data3,1));
x = 1:Bbins + Tbins;
y3 = mean(data3);
error3 = errorbar(x, y3, sem3);
...
%% plot4
data4 = ratematrix4(result4(result4(:,2) == 0, 1),1:Bbins + Tbins);
sem4 = std(data4)/sqrt(size(data4,1));
x = 1:Bbins + Tbins;
y4 = mean(data4);
error4 = errorbar(x, y4, sem4);
